...
def main():
    ...
    # 第二次请求
    cookie_2 = build_cookie_string(response_1.cookies, cookies_1, response_1.cookies.get("_WEU"))
    headers_2 = {
        "Cookie": cookie_2,
        "User-Agent": UA
    }
    ...
    # 构建最终请求
    cookie_3 = build_cookie_string(response_1.cookies, cookies_1, response_2.cookies.get("_WEU"))
    headers_3 = {
        "Cookie": cookie_3,
        "Token": token_jnu,
        "User-Agent": UA
